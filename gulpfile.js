...
gulp.task("styles", function() {
	 gulp.src(path.src.scss) //путь
		...
		.pipe(autoprefixer({
			...
			.pipe(sass({
				 restructure: true, //минимизация по умолчанию true
			}))
			.pipe(cssnano()) //минимизация, удаление лишнего, объединение
...
gulp.task("default", ["pug" ,"styles", "fonts", "js", "scripts", "watch", 'bowersync']);